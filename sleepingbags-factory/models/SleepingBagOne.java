...
public class SleepingBagOne implements SleepingBag {
    private String purpose;
    private String weatherRatings;
    private String size;
    private String temperatureRatings;

    public SleepingBagOne() {
        this.weatherRatings = Constants.S_ONE_WEATHER_RATINGS;
        this.purpose = Constants.SC_PURPOSE;
    }
